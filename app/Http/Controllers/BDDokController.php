...
class BDDokController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($record){
            return redirect()->route('bd-harian-detail.index', ['bd_harian' => $request->id_tiket])->with(['success' => 'Data Berhasil Ditambah!']);
        }
        else{
            return redirect()->route('bd-harian-detail.index', ['bd_harian' => $request->id_tiket])->with(['error' => 'Data Gagal Ditambah!']);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($record){
            return redirect()->route('bd-harian-detail.index', ['bd_harian' => $fileID])->with(['success' => 'Data Berhasil Diupdate!']);
        }
        else{
            return redirect()->route('bd-harian-detail.index', ['bd_harian' => $fileID])->with(['error' => 'Data Gagal Diupdate!']);
        }
    }
